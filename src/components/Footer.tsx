import {Twitter, Linkedin, Mail, Github, Instagram, Facebook} from 'lucide-react';
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-6">
        <div className="flex flex-col items-start gap-y-4 md:w-1/3">
...

          {
            ...
            <a target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="p-2 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors" href="https://x.com/israeliyev_me">
              <Twitter className="w-3.5 h-3.5" />
            </a>

               <a target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors" href="https://instagram.com/israeliyev">
                 <Instagram className="w-4 h-4" />
               </a>

               <a target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors" href="https://www.facebook.com/israel.aliyev.2025/">
        ...
        <div className="flex-1 grid grid-cols-2 sm:grid-cols-3 gap-6 text-left">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2 text-xs text-slate-600 dark:text-slate-400 font-medium">
              <a target="_blank" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="https://dev.to/israeliyev">Blog</a>
              <a target="_blank" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="https://github.com/israeliyev">Github</a>
            </div>
          </div>
          <div className="flex flex-col gap-3 col-span-2 sm:col-span-1">
            ...
            <div className="flex items-center gap-2 mt-1">
              {/* email */}
              <a target="_blank" rel="noopener noreferrer" aria-label="Mail" className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors" href="mailto:israelaliyev36@gmail.com">
                <Mail className="w-4 h-4" />
              </a>
              <a target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors" href="https://github.com/israeliyev">
      ...
      <div className="mt-8 pt-4 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-3 text-[11px] text-slate-600 dark:text-slate-400 font-medium">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
          <p>Built with ❤️ by <a target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors underline underline-offset-2" href="https://www.linkedin.com/in/israeliyev/"></a></p>
        </div>
      </div>
      </footer>
    </>
