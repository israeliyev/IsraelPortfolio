...
import profileImg from '../../assets/circle-isi.webp';
  ...
  return (
      ...
      >
        <div className="flex items-center gap-2.5 min-w-0">
          <a href="https://www.instagram.com/israeliyev/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile">
            <img
                alt="Profile"
                fetchPriority="high"
        ...
        <div className="items-center gap-2 sm:gap-6 flex shrink-0">
          ...
          <div className="flex items-center gap-1 sm:gap-3">
            <a target="_blank" aria-label="LinkEdin Profile" className="cursor-pointer p-1.5 rounded-md hover:bg-slate-200 hover:text-slate-600 dark:hover:bg-slate-800 dark:hover:text-slate-300 transition-colors" href="https://www.linkedin.com/in/israeliyev">
              <Linkedin className="w-4 h-4" />
            </a>
            <a target="_blank" aria-label="GitHub Profile" className="cursor-pointer p-1.5 rounded-md hover:bg-slate-200 hover:text-slate-600 dark:hover:bg-slate-800 dark:hover:text-slate-300 transition-colors" href="https://github.com/israeliyev">
              <Github className="w-3.5 h-3.5" />
            </a>
            <a href="https://drive.google.com/file/d/1RROmt0xiXDURC1YgpbGKiQZzFfy1uHXJ/view?usp=drive_link" target="_blank" aria-label="Download Resume" className="group relative hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 rounded-full text-[11px] font-mono font-bold hover:bg-slate-800 dark:hover:bg-slate-200 transition-all shadow-md">
              <span>Resume</span>
